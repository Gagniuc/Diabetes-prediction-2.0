...
Begin VB.Form Form1 
   AutoRedraw      =   -1  'True
   Caption         =   "Diabetes prediction prototype v2.0"
   ClientHeight    =   9075
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   16725
   ...
   ForeColor       =   &H00404040&
   LinkTopic       =   "Form1"
   Picture         =   "MCD_main.frx":0000
   ScaleHeight     =   605
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   1115
   StartUpPosition =   2  'CenterScreen
   Begin VB.PictureBox VU 
      Appearance      =   0  'Flat
      AutoRedraw      =   -1  'True
      BackColor       =   &H00FFFFFF&
      BeginProperty Font 
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   4080
      Width           =   5295
      Begin VB.TextBox ThrT 
         Height          =   285
         Left            =   3840
         TabIndex        =   43
         Text            =   "108"
         ToolTipText     =   "Fasting blood glucose (mg/dL)"
         Top             =   1320
         Width           =   1215
      End
...
' |             Use:  Markov chains example for diabetes                          |
' |                                                                               |
...
Private Sub Solve_n_Click()
    ...
    If Option1(0).Value = True Then
        ...
        'Text1.Text = Transform(Gly.Text)
        Else
        Call ExtractProb(Transform2(Gly.Text))
        'Text1.Text = Transform(Gly.Text)
    End If
    ...
    For i = 0 To cicle
        ...
        If (v1.Text = x.Caption And v2.Text = y.Caption) Then
            Text1.Text = Text1.Text & "Steady state vector at [" & i & "] !" & vbCrLf & vbCrLf
            ...
            Else
                Text1.Text = Text1.Text & "The threshold glucose level was set at " & _
                Gtr & " mg/dL (representing the normal level of blood sugar)" & vbCrLf & vbCrLf
            End If
            ...
            Call VUF(Round(100 * Val(P22.Text)))
        ...
        Else
            ...
            If Val(x.Caption) > Val(y.Caption) Then
                Text1.Text = Text1.Text & "L[" & i + 1 & "] = [" & Round(x.Caption, 12) & " - " & Round(y.Caption, 12) & "]" & vbCrLf
            Else
                Text1.Text = Text1.Text & "H[" & i + 1 & "] = [" & Round(x.Caption, 12) & " - " & Round(y.Caption, 12) & "]" & vbCrLf
            End If
...
Function Transform2(ByVal r As String) As String
...
Function ExtractProb(ByVal s As String)
    ...
    'If TB = 0 Then TB = 1 '0.001
    'If TS = 0 Then TS = 1 '0.001
...
Function VUF(ByVal h As Variant)

    VU.Cls
    Dim vals As Long
    
    vals = (360 - ((180 / 100) * (100 - h)))
    CLines vals, 3, vbBlack, VU 'prima este 0 - 360
